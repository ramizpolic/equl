...
### TODO
- [x] Expose better interface for equality check (which also includes custom filtration function)
- [x] Add support for specifying `WithFields` and `WithoutFields` for sub-field filtering
- [x] Write more complete test scenarios
